...
import joyup from '../assets/images/joyup.png';
import canine from '../assets/images/canine.gif';
...
const Projects = (props) => {
  ...
  const projects = [
    ...
    //   id: 23,
    //   name: 'Make Schol',
    //   about: 'YC W12 Make School Product College is the worlds first accredited software engineering college.',
    //   image: makeschool
    // },
    {
      id: 3,
    ...
    {
      id: 31,
      name: 'The Canine Club of Chicago',
      about: 'Dog training company in Chicago.',
      image: canine
    },
    {
      id: 16,
      name: 'Joy Up',
      about: 'Silicon Valley YC backed startup bringing Uber eats style ordering to Facebook Messenger',
      image: joyup
    },
    {
      id: 4,
